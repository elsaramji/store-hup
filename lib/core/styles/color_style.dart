...
class AppColors {
  ...
  static const Color green1500 = Color(0xff1b5e37);
  static const Color green150 = Color(0xffebf9f1);
  static const Color green1950 = Color(0xff06140c);
  static const Color green1100 = Color(0xffd7f4e3);
  static const Color green1200 = Color(0xffb0e8c7);
  static const Color green1300 = Color(0xff88ddab);
  static const Color green1400 = Color(0xff60d290);
  static const Color green1600 = Color(0xff2d9f5d);
  static const Color green1700 = Color(0xff227745);
  static const Color green1800 = Color(0xff174f2e);
  static const Color green1900 = Color(0xff0b2817);
}
